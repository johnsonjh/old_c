...
ELSE
DGROUP	GROUP	_DATA, _EMUSEG, _CVTSEG, _SCNSEG
ENDIF
ELSE
IFNDEF	__TINY__
...
;	Capture "Divide error" interrupt
...
STARTX		ENDP
	...
	SUBTTL	Zero divide exception routines
	PAGE
;[]------------------------------------------------------------[]
;|								|
;|	Zero divide exception routines				|
;|								|
;[]------------------------------------------------------------[]
...
;|			segment before to be absolutely	 sure	|
...
PubSym@		ZeroDivVector	<dd	0>,		__CDECL__
