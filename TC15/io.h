...
int  _Cdecl access	 (const char *filename, int amode);
int  _Cdecl _chmod	 (const char *pathname, int func, ... /* int attr */);
int  _Cdecl chmod	 (const char *filename, int amode);
...
int  _Cdecl _open	 (const char *filename, int oflags);
...
int  _Cdecl unlink	 (const char *filename);
