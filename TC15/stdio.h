...
int      _Cdecl fgetpos  (FILE *fp, fpos_t *pos);
...
int      _Cdecl fputc    (int c, FILE *fp);
int      _Cdecl fputs    (const char *s, FILE *fp);
size_t   _Cdecl fread    (void *ptr, size_t size, size_t n, FILE *fp);
FILE    *_Cdecl freopen  (const char *filename, const char *mode, 
                          FILE *oldfile);
int      _Cdecl fscanf   (FILE *fp, const char *format, ...);
int      _Cdecl fseek    (FILE *fp, long offset, int whence);
int      _Cdecl fsetpos  (FILE *fp, const fpos_t *pos);
...
void     _Cdecl setbuf   (FILE *fp, char *buf);
int      _Cdecl setvbuf  (FILE *fp, char *buf, int type, size_t size);
...
int      _Cdecl vfprintf (FILE *fp, const char *format, va_list arglist);
int      _Cdecl vfscanf  (FILE *fp, const char *format, va_list arglist);
...
int      _Cdecl putw     (int w, FILE *fp);
char    *_Cdecl _strerror(const char *string);
