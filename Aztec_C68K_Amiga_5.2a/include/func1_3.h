...
long IoErr(void);
struct MsgPort *CreateProc(const char *name, long pri, BPTR segList, long stackSize);
void Exit(long returnCode);
BPTR LoadSeg(const char *fileName);
...
void Debug( unsigned long flags );	/* 9/3/91 changed args from void */
void Disable(void);
void Enable(void);
void Forbid(void);
void Permit(void);
...
struct MiscResource * OpenResource(const char *); /* 9/3/91 deleted arg 2 */
void RawIOInit(void);
...
void SetPointer(struct Window *Window,unsigned short *Pointer,long Height,long Width,long Xoffset,long Yoffset);
...
long AllocUnit(struct MiscResource *DRResource, long unitNum);
void FreeUnit(struct MiscResource *DRResource, long unitNum);
long GetUnit(struct MiscResource *DRResource, struct DiscResourceUnit *unitPointer);
long GetUnitID(struct MiscResource *DRResource, long unitNum);
void GiveUnit(struct MiscResource *DRResource);

char *AllocMiscResource(struct MiscResource *Resource, long unitNum, char *name);
void FreeMiscResource(struct MiscResource *Resource, long unitNum);
