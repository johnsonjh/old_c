 ...
 *				     for Lattice C 5.x or Aztec C 3.6	*
 *				     and 5.0				*
 *									*
 ************************************************************************
 *									*
 ...
 *	wonderful #pragma statements of Lattice 5.0..., but Aztec 5.0a	*
 *	does.								*
...
#define SET_ID(t,id)    ((SHORT *) t)[-1]=id
...
struct	DirectoryEntry		*AddDANode		ARGs(   (char *, struct DirectoryEntry **, LONG, LONG)          );
	...
	LONG			Strncmp 		ARGs(   (char *, char *, LONG)                                  );
							    /* glue function handles "int" correctly */
	BYTE			Toupper 		ARGs(   (int)                                                   );
