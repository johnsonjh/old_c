...
enum graphics_modes {       /* graphics modes for each driver */
    ...
    DOSVGA16   = 0,  /* 640x475 16 color            */
    DOSVGA2    = 1,  /* 640x480  2 color            */
    DOSVGA16HI = 2,  /* 640x480 16 color            */
    DOSVGA16LO = 3,  /* 640x480 16 color            */
    DOSVGA16EX = 4,  /* 640x475 16 color            */
    PC98C8     = 0,  /* 640x400  8 color 2 page     */
    PC98C16    = 1,  /* 640x400 16 color 2 page     */
    PC98HIC8   = 0,  /*1120x750  8-color emulation  */
    PC98HIC16  = 1   /*1120x750 16 color            */
};
...
enum font_names {
    DEFAULT_FONT    = 0,    /* bit mapped font, depend on machine */
...
void           _RTLENTRY DOSVGA_driver(void);
void           _RTLENTRY PC98_driver(void);
void           _RTLENTRY PC98HI_driver(void);
...
void           _RTLENTRY DOSVGA_driver_far(void);
void           _RTLENTRY PC98_driver_far(void);
void           _RTLENTRY PC98HI_driver_far(void);
#else
...
extern int far _RTLENTRY DOSVGA_driver_far[];
extern int far _RTLENTRY PC98_driver_far[];
extern int far _RTLENTRY PC98HI_driver_far[];
#endif
...
void           _RTLENTRY      script_font(void);
void           _RTLENTRY     simplex_font(void);
void           _RTLENTRY triplex_scr_font(void);
void           _RTLENTRY     complex_font(void);
void           _RTLENTRY        euro_font(void);
void           _RTLENTRY        bold_font(void);
...
extern int far _RTLENTRY      script_font_far[];
extern int far _RTLENTRY     simplex_font_far[];
extern int far _RTLENTRY triplex_scr_font_far[];
extern int far _RTLENTRY     complex_font_far[];
extern int far _RTLENTRY        euro_font_far[];
extern int far _RTLENTRY        bold_font_far[];
