...
#define BLINK           0x0100  /* NECPC and some IBMPC modes only */ 
#define REVERSE         0x0200  /* NECPC only */
#define UNDERLINE       0x0400  /* NECPC only */
#define VERTICALLINE    0x0800  /* NECPC only */
#define OVERLINE        0x1000  /* NECPC DOS E80xx mode only */
...
extern   int _RTLENTRY _wclrnorm;
extern   int _RTLENTRY _wgarbage;
extern   int _RTLENTRY _wkanji;
extern   int _RTLENTRY _wnewline;
extern   int _RTLENTRY _wscroll;
extern   int _RTLENTRY _wedgectrl;
...
void        _RTLENTRY textkanji( int __kanjiflag );
...
int         _RTLENTRY vcprintf( const char *__format, void *__arglist );
int         _RTLENTRY vcscanf( const char *__format, void *__arglist );
int         _RTLENTRY _getputtextsize( int __left, int __top, int __right, int __bottom );
...
extern   int _RTLENTRY _EXPDATA _wclrnorm;
extern   int _RTLENTRY _EXPDATA _wgarbage;
extern   int _RTLENTRY _EXPDATA _wkanji;
extern   int _RTLENTRY _EXPDATA _wnewline;
extern   int _RTLENTRY _EXPDATA _wscroll;
extern   int _RTLENTRY _EXPDATA _wedgectrl;
...
void        _RTLENTRY _EXPFUNC textkanji( int __kanjiflag );
...
int         _RTLENTRY _EXPFUNC vcprintf( const char *__format, void *__arglist );
int         _RTLENTRY _EXPFUNC vcscanf( const char *__format, void *__arglist );
