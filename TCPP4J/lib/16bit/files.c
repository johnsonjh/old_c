...
/*
 * This pull the initialize routine of Standard I/O.
 * We moved this external symbol from C0.ASM US-Original code.
 * A small executable file is made if Standard I/O was not used.
 */
extern void _setupio();
#pragma extref _setupio
