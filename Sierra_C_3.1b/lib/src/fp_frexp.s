...
not_nan_nor_inf:
    ...
    andi.l  #0x807fffff,d2	    ; remove exponent from value
    ori.l   #0x3f000000,d2	    ; insert 2^-1 exponent back into value
    swap    d1			    ; move original exponent from value to d1
    lsr.w   #7,d1
    andi.w  #0xff,d1		    ; mask off original exponent
    subi.w  #0x7e,d1		    ; normalize original exponent
 .ifdef INT_16
