...
*
*   Sierra Systems C Run Time (CRT) header, 020bug version
*
...
;   move.b  #0xfe,0xfffb003a; clear VM04 on-board cache
;   move.b  #0xf0,0xfffb003a; turn on VM04 on-board cache see pgs 54 & 91
    rts

cache_off:
    moveq   #0x8,d0
    movec   d0,cacr	    ; clear and disable instruction cache
;   move.b  #0xf6,0xfffb003a; turn off VM04 on-board cache see pgs 54 & 91
    rts

monitor:
    move.l  (sp)+,d0	    ; put return value from _exit into d0
    trap    #15
    .word   0x63	    ; return to 020bug
