...
*
*   Sierra Systems C Run Time (CRT) header, 147bug version
*
...
;   jmp	    __xcptn_info_020; default 68020/30 exception handler

startup:
    move.l  #0x808,d0
    movec   d0,cacr	    ; clear both instruction and data caches
    move.l  #0x101,d0
    movec   d0,cacr	    ; enable both instruction and data caches
    rts

cache_off:
    move.l  #0x808,d0
    movec   d0,cacr	    ; clear and disable both inst and data caches
    rts

monitor:
    move.l  (sp)+,d0	    ; put return value from _exit into d0
    trap    #15
    .word   0x63	    ; return to 147bug
